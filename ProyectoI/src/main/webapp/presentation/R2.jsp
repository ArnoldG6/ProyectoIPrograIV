        ...
        <form name="form" action="/Guia/presentation/login/login" method="post" > 
            <div>
                ...
                <div>
                       <div>Cedula</div>
                      <div>
                          <input class="<%=erroneo("cedulaFld",errores)%>" placeholder="Cedula del usuario" type="text" name="cedulaFld" value="<%=form.get("cedulaFld")[0]%>" title="<%=title("cedulaFld",errores)%>"></div>
                </div>
                <div class="fila">
